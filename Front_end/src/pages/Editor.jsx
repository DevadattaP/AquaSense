...
//                 <h1 className="text-3xl mb-5 text-center pb-4" style={{ fontSize: '45px' }}>New Tap Connection Form</h1>
...
//                                 <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Address</label>
//                                 <input type="text" name="address" value={formData.address} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Postal Code</label>
//                                 <input type="text" name="postalCode" value={formData.postalCode} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Mobile Number</label>
//                                 <input type="tel" name="mobileNumber" value={formData.mobileNumber} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Email</label>
//                                 <input type="email" name="email" value={formData.email} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                         </form>
//                     </div>
...
//                                 <input type="text" name="propertyNumber" value={formData.propertyNumber} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Property Type</label>
//                                 <select name="propertyType" value={formData.propertyType} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500">
...
//                                 <input type="text" name="population" value={formData.population} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Number of Floors</label>
//                                 <input type="text" name="numOfFloors" value={formData.numOfFloors} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Number of Flats</label>
//                                 <input type="text" name="numOfFlats" value={formData.numOfFlats} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                         </form>
//                     </div>
...
//                                 <input type="text" name="connectionType" value={formData.connectionType} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Category</label>
//                                 <input type="text" name="category" value={formData.category} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Connection Size (in mm)</label>
//                                 <input type="text" name="connectionSize" value={formData.connectionSize} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Area Type</label>
//                                 <input type="text" name="areaType" value={formData.areaType} onChange={handleInputChange} className="w-full px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" />
//                             </div>
//                         </form>
//                     </div>
...
//                                 <input type="file" name="identityProof" onChange={handleInputChange} />
//                             </div>
//                             <div>
//                                 <label className="block mb-1 font-semibold">Residential Proof</label>
//                                 <input type="file" name="residentialProof" onChange={handleInputChange} />
//                             </div>
//                         </form>
//                     </div>
//                 </div>
//                 <div className="flex justify-center mt-8">
//                     <button type="submit" className="bg-indigo-500 text-white px-4 py-2 rounded-lg hover:bg-indigo-600 transition duration-300" onClick={handleSubmit}>Submit</button>
//                 </div>
//             </div>
//         </div>
//     );
